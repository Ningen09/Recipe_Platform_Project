...
import { userCommentListMock, userMock, userRecipeListMock, userRecipeReviewListMock, userWritingRecipeListMock } from "mocks";
import { usePagination } from "hooks";
import { UserCommentItem, UserRecipeItem, UserRecipeReviewItem, UserWritingRecipeItem } from "Types";
...
import UserWritingCommentListItem from "components/UserWritingCommentList";
...
export default function User() {
                            ...
                            {page === 1 && (
                                ...
                                <div className='user-board-content'>
                                    <ul className='user-board-sub-tep'>
                                        ...
                                        <div className='user-board-sequence'>
                                            <li className='user-sub-tep-title-latest' style={{backgroundColor:'#B2D3B7'}}>{'최신순'}</li>
                                            <li role='user-board-tep-presentation' className='user-sub-tep-title-like' onClick={onSubTepButtonClickHandler}>{'좋아요순'}</li>
                                        </div>
                                    </ul>
                            ...
                            {page === 2 && (
                                ...
                                <div className='user-board-content'>
                                    <ul className='user-board-sub-tep'>
                                        ...
                                        <div className='user-board-sequence'>
                                            <div className='user-sub-tep-title-latest' onClick={onSubTepButtonClickHandler}>{'최신순'}</div>
                                            <li role='user-board-tep-presentation' className='user-sub-tep-title-like' style={{backgroundColor:'#B2D3B7'}}>{'좋아요순'}</li>
                                        </div>
                                    </ul>
                                    <div className='user-board-box'>
                                        {viewBoardList.map((recipeItem => <UserRecipeList userRecipeItem={recipeItem}/>))}
    ...
    const UserRecipeReview = () => {
        ...
        //          state: 페이지네이션 관련 상태          //
        const { currentPageNumber, setCurrentPageNumber, currentSectionNumber, setCurrentSectionNumber,
            viewBoardList, viewPageNumberList, totalSection, setBoardList } = usePagination<UserRecipeReviewItem>(16);
        //          state: 게시물 개수 상태          //
        const [count, setCount] = useState<number>(16);
                        ...
                        <div role='user-main-recipe' className='user-main-recipe-box'>
                            ...
                            {page === 2 && (
                                ...
                                <div className='user-review-board-content'>
                                    ...
                                    <div className='user-review-board-box'>
                                        {viewBoardList.map((recipeReviewItem => <UserWriteRecipeReviewList userWriteRecipeReviewItem={recipeReviewItem    }/>))}
                                    </div>
                                </div>
                            )
                            )}
    ...
    const UserRecipeComment = () => {
        ...
        //          state: 페이지네이션 관련 상태          //
        const { currentPageNumber, setCurrentPageNumber, currentSectionNumber, setCurrentSectionNumber,
            viewBoardList, viewPageNumberList, totalSection, setBoardList } = usePagination<UserCommentItem>(8);
        //          state: 게시물 개수 상태          //
                        ...
                        <div role='user-main-recipe' className='user-main-recipe-box'>
                            ...
                            {page === 2 && (
                                ...
                                <div className='user-review-board-content'>
                                    ...
                                    <div className='user-comment-board-container'>
                                    {viewBoardList.map((recipeReviewItem => <UserWritingCommentListItem userCommentItem={recipeReviewItem}/>))}
                                    </div>
                                </div>
                            )
                            )}
            ...
            <div id='user-board-sub'>
                    <div className='user-recent-post-container'>
                        ...
                        <div className='user-recent-post-list-button-top'>
                            <div className='circle-top-button-icon'></div>
                        </div>
                        <div className='user-recent-post-list'>
                            <div className='user-recent-post-box'>
                                <div className='user-recent-post'>
                                    <div className='user-recent-post-image'>
                                        <div className='temporary-image-01'></div>
                                    </div>
                                    <div className='user-recent-post-title'>{'스파게티 맛있겠다.'}</div>
                                </div>
                            </div>
                            <div className='user-recent-post-box'>
                                <div className='user-recent-post'>
                                    <div className='user-recent-post-image'>
                                        <div className='temporary-image-02'></div>
                                    </div>
                                    <div className='user-recent-post-title'>{'핫케이크 맛있겠다.'}</div>
                                </div>
                            </div>
                            <div className='user-recent-post-box'>
                                <div className='user-recent-post'>
                                    <div className='user-recent-post-image'>
                                        <div className='temporary-image-03'></div>
                                    </div>
                                    <div className='user-recent-post-title'>{'백김치 맛있겠다.'}</div>
                                </div>
                            </div>
                            <div className='user-recent-post-box'>
                                <div className='user-recent-post'>
                                    <div className='user-recent-post-image'>
                                        <div className='temporary-image-04'></div>
                                    </div>
                                    <div className='user-recent-post-title'>{'김치볶음밥..맛있겠다.'}</div>
                                </div>
                            </div>
                            <div className='user-recent-post-box'>
                                <div className='user-recent-post'>
                                    <div className='user-recent-post-image'>
                                        <div className='temporary-image-05'></div>
                                    </div>
                                    <div className='user-recent-post-title'>{'브런치도.. 맛있겠다.. '}</div>
                                </div>
                            </div>
                        </div>
                        <div className='user-recent-post-list-button-bottom'>
                            <div className='circle-bottom-button-icon'></div>
                        </div>
                    </div>
                </div>
